<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CertiWebTest.Login" %>
...
{
	text-align: left;
	background: url(https://www.comune.roma.it/was/wps/themes/html/pcrTheme/images/testatapcr.jpg) #ff9629 repeat-x;
	padding-top: 120px;
}
div#titoloarea
{
...
#formricerca .right
{
	...
	max-width: 300px;
	margin-bottom: 0.3em;
	background: url(https://www.comune.roma.it/was/wps/themes/html/pcrTheme/images/cerca.gif) no-repeat;
	font-size: 0.7em;
	border-top: medium none;
	border-right: medium none;
	padding-top: 0px;
...
ul#macro
{
	...
	width: 28.5em;
	padding-right: 20px;
	background: url(https://www.comune.roma.it/was/wps/themes/html/pcrTheme/images/titoloGruppo-hr.gif) no-repeat right top;
	color: #fff;
	font-size: 0.65em;
	border-top: medium none;
	top: -36px !important;
...
H3
{
	...
	padding-left: 0.4em;
	padding-right: 65px;
	background: url(https://www.comune.roma.it/was/wps/themes/html/pcrTheme/images/titoloServizi.gif) #ccccff no-repeat 100% 0px;
	color: #fff;
	font-size: 0.9em;
	padding-top: 0.2em;
}
...
<p class="txtright">
<TextBox ID="username" MaxLength="40"  runat="server"  />
</p>
<p class="left">
<label for="password">password:</label>
</p>
<p class="txtright">
<TextBox ID="password" runat="server" MaxLength="40"  />
</p>
<div class="txtright">
<asp:Button runat="server" ID="accedi" runat="server" CssClass="frmbtn" Text="accedi" ToolTip="Entra nell'area riservata" />
...
<ul>
<li>
<a title="Verifica la validit� del codice XHTML 1.0" href="http://validator.w3.org/check?uri=http://www.comune.roma.it/was/wps/portal/pcr"><IMG alt="XHTML 1.0 Valido!" src="https://www.comune.roma.it/was/wps/themes/html/pcrTheme/images/valid-xhtml10.gif" width="88" height="31" /></a>
</li>
<li>
<a title="Verifica la validit� dei fogli di stile" href="http://jigsaw.w3.org/css-validator/validator?uri=http://www.comune.roma.it/was/wps/portal/pcr"><IMG alt="CSS Valido!" src="https://www.comune.roma.it/was/wps/themes/html/pcrTheme/images/vcss.gif" width="88" height="31" /></a>
</li>
</ul>
</div>
</body> 
