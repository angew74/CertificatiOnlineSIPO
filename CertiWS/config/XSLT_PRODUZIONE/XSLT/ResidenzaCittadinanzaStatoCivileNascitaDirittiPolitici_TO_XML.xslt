  ...
  <xsl:template match="/">
    ...
    <RispostaCertificato xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
      ...
      <xsl:for-each select="//OpenTI/INDIVIDUO">
        ...
        <xsl:if test="./NOMEC != '' and ./STATCIV = 'vedovo' or ./STATCIV = 'vedova'">
          <coniuge>
        ...
        <xsl:if test="./NOMEC != '' and ./STATCIV = 'coniugato' or ./STATCIV = 'coniugata'">
          <coniuge>
        ...
        <xsl:if test="./VIA != ''">
          ...
          <xsl:if test="./STATCIV != 'celibe' or ./STATCIV != 'nubile' or ./STATCIV != 'vedovo' or ./STATCIV != 'vedova' or ./STATCIV != 'vedova di unione' or ./STATCIV != 'vedovO di unione'  or ./STATCIV != 'già coniugato' or ./STATCIV != 'già coniugata'">
            <matrimonio>
              <dataMatrimonio>
