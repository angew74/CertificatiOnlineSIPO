...
namespace Com.Unisys.CdR.Certi.WebApp.Business.ProxyWS
{
    ...
    public partial class SP : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public SP() {
            this.Url = "http://10.173.17.56:8080/sp/services/SP.SPHttpSoap11Endpoint/";
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsecurizeBuffer(string serviceId, byte[] buffer, byte[] inXml, byte[] xmlData, SignerBean[] signers, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("securizeBuffer", new object[] {
                        serviceId,
                        buffer,
                        inXml,
                        xmlData,
        ...
        /// <remarks/>
        public SPServiceResponse EndsecurizeBuffer(System.IAsyncResult asyncResult) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsecurizeMessageDigestOnPdfWithKeys(string serviceId, string messageDigest, string messageDigestType, byte[] inPdf, byte[] xmlData, SignerBean[] signers, Key[] keys, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("securizeMessageDigestOnPdfWithKeys", new object[] {
                        serviceId,
                        messageDigest,
                        messageDigestType,
                        inPdf,
        ...
        /// <remarks/>
        public SPServiceBaseResponse EndsecurizeMessageDigestOnPdfWithKeys(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((SPServiceBaseResponse)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsecurizeXML(string serviceId, byte[] inXml, SignerBean[] signers, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("securizeXML", new object[] {
                        serviceId,
                        inXml,
                        signers}, callback, asyncState);
        }
        ...
        /// <remarks/>
        public SPServiceResponse EndsecurizeXML(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((SPServiceResponse)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsecurizePDF(string serviceId, byte[] inPdf, SignerBean[] signers, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("securizePDF", new object[] {
                        serviceId,
                        inPdf,
                        signers}, callback, asyncState);
        }
        ...
        /// <remarks/>
        public SPServiceResponse EndsecurizePDF(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((SPServiceResponse)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsecurizePDFWithClosingDocument(string serviceId, byte[] inPdf, byte[] closingDocumentXml, SignerBean[] signers, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("securizePDFWithClosingDocument", new object[] {
                        serviceId,
                        inPdf,
                        closingDocumentXml,
                        signers}, callback, asyncState);
        ...
        /// <remarks/>
        public SPServiceResponse EndsecurizePDFWithClosingDocument(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((SPServiceResponse)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsecurizeBufferOnPdf(string serviceId, byte[] buffer, byte[] inPdf, byte[] xmlData, SignerBean[] signers, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("securizeBufferOnPdf", new object[] {
                        serviceId,
                        buffer,
                        inPdf,
                        xmlData,
        ...
        /// <remarks/>
        public SPServiceResponse EndsecurizeBufferOnPdf(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((SPServiceResponse)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsecurizeXMLWithClosingDocument(string serviceId, byte[] inXml, byte[] closingDocumentXml, SignerBean[] signers, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("securizeXMLWithClosingDocument", new object[] {
                        serviceId,
                        inXml,
                        closingDocumentXml,
                        signers}, callback, asyncState);
        ...
        /// <remarks/>
        public SPServiceResponse EndsecurizeXMLWithClosingDocument(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((SPServiceResponse)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsecurizeBufferOnPdfWithKeys(string serviceId, byte[] buffer, byte[] inPdf, byte[] xmlData, SignerBean[] signers, Key[] keys, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("securizeBufferOnPdfWithKeys", new object[] {
                        serviceId,
                        buffer,
                        inPdf,
                        xmlData,
        ...
        /// <remarks/>
        public SPServiceResponse EndsecurizeBufferOnPdfWithKeys(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((SPServiceResponse)(results[0]));
        }
