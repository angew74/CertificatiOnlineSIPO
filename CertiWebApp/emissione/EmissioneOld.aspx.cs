    ...
    public partial class Emissione : Com.Unisys.CdR.Certi.WebApp.common.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    // solo per test   
                    cf1 = Config.ReadSetting("TEST_ACCOUNT");
        ...
        private void LoadIntestatarioAvvo(NCRIRICIND.PersonaElencoRow persona)
        {
            ...
            try
            {
                ...
                if (richiedente.UtenteUM == "S" && string.IsNullOrEmpty(persona.CodiceFiscale))
                {
                    ...
                    idRic = flu.ExecuteInizializza(Config.ReadSetting("ClientID"), richiedente.CodiceFiscale,
        ...
        protected override void Page_PreRender(object sender, EventArgs e)
        {
            ...
            switch (fase.Value)
            {
                ...
                case "4":
                    ...
                    pnlCertificatiRo.Visible = true;
                    pnlMotivazioni.Visible = false;
                    PnlMotivazioniro.Visible = ((idTipoUso.Value == "1") ? true : false);
        ...
        protected void btnIntestatario_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string idRic = flu.ExecuteInizializza(Config.ReadSetting("ClientID"), richiedente.CodiceFiscale,
        ...
        protected void rbCert_CheckedChanged(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < rptCertificati.Items.Count; i++)
            {
                ...
                if (rb.GroupName == (sender as RadioButton).GroupName)
                {
                    ...
                    {
                        idTipoUso.Value = "3";
                        lblCertificato.Text = (rptCertificati.Items[i].FindControl("certNome") as Label).Text;
                    }
                }
                else
                {
        ...
        protected void btnOn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                idClient = int.Parse(Config.ReadSetting("ClientID"));
            ...
            else
            {
                try
                {
                    ...
                    fase.Value = "5";                   
                    string backPage = Config.ReadSetting("BackPage");
        ...
        private void LoadNewRichiedente()
        {
            ...
            else
            {
                ...
                richiedente.CodiceIndividuale = Com.Unisys.CdR.Certi.WebApp.Business.Utility.Utils.ConvertToUTF8("RSSGRG60D01H501W");
                richiedente.Cognome = Com.Unisys.CdR.Certi.WebApp.Business.Utility.Utils.ConvertToUTF8("COGNOME");
                richiedente.CodiceFiscale = "RSSGRG60D01H501W";
                richiedente.Sesso = "F";
            ...
            inf.flussoID = "";
            inf.clientID = Config.ReadSetting("ClientID");
        ...
        private void LoadListaFamiglia()
        {
            ...
            try
            {
                famiglia = flu.CallRicercaComponenti(Config.ReadSetting("ClientID"), richiedente.CodiceFiscale,
